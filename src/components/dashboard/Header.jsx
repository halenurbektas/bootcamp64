            ...
            {isProfileMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700/50 text-slate-800 dark:text-white overflow-hidden animate-fade-in-down">
                    <div className="p-4 border-b border-slate-200 dark:border-slate-700/50">
                        <p className="font-bold">Nermin</p>
                        <p className="text-sm text-slate-500 dark:text-slate-400">Puan: 7650 - Usta Çözücü</p>
                    </div>
                    <nav className="p-2">
                        ...
                        <Link to="/login" onClick={() => setProfileMenuOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/50 text-red-500 dark:text-red-400"><LogOut size={18}/> Çıkış Yap</Link>
                    </nav>
                </div>
            )}
          </div>
